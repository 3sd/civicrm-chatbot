 ...
 */
function _chatbot_civirules_civix_civicrm_config(&$config = NULL) {
 ...
 */
function _chatbot_civirules_civix_civicrm_xmlMenu(&$files) {
 ...
 */
function _chatbot_civirules_civix_civicrm_install() {
  _chatbot_civirules_civix_civicrm_config();
 ...
 */
function _chatbot_civirules_civix_civicrm_postInstall() {
  _chatbot_civirules_civix_civicrm_config();
  if ($upgrader = _chatbot_civirules_civix_upgrader()) {
 ...
 */
function _chatbot_civirules_civix_civicrm_uninstall() {
  _chatbot_civirules_civix_civicrm_config();
  if ($upgrader = _chatbot_civirules_civix_upgrader()) {
 ...
 */
function _chatbot_civirules_civix_civicrm_enable() {
  _chatbot_civirules_civix_civicrm_config();
  if ($upgrader = _chatbot_civirules_civix_upgrader()) {
 ...
 * @return mixed
 */
function _chatbot_civirules_civix_civicrm_disable() {
  _chatbot_civirules_civix_civicrm_config();
  if ($upgrader = _chatbot_civirules_civix_upgrader()) {
 ...
 */
function _chatbot_civirules_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _chatbot_civirules_civix_upgrader()) {
 ...
 */
function _chatbot_civirules_civix_civicrm_caseTypes(&$caseTypes) {
 ...
 */
function _chatbot_civirules_civix_civicrm_angularModules(&$angularModules) {
 ...
 */
function _chatbot_civirules_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  static $configured = FALSE;
  if ($configured) {
    return;
  }
...
function _chatbot_civirules_civix_civicrm_entityTypes(&$entityTypes) {
